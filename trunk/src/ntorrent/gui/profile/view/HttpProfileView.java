...
public class HttpProfileView extends AbstractClientProfileView  {
	...
	HttpProfileModel model;
	ProxyProfileView proxy;
		
	public HttpProfileView(HttpProfileModel model) {
		super(model);
		this.model = model;
	...
	private void initListeners() {
		...
		mountpoint.addFocusListener(this);
	...
	private void initDisplay(){
		hostLabel = new JLabel(Constants.messages.getString("profile.host"));
		portLabel = new JLabel(Constants.messages.getString("profile.connectionport"));
		usernameLabel = new JLabel(Constants.messages.getString("profile.username"));
		passwordLabel = new JLabel(Constants.messages.getString("profile.password"));
		rememberPwdLabel = new JLabel(Constants.messages.getString("profile.rememberpwd"));
		autoConnLabel = new JLabel(Constants.messages.getString("profile.autoconnect"));
		mountpointLabel = new JLabel(Constants.messages.getString("profile.mountpoint"));
		...
		mountpoint.setText(""+model.getMountpoint());
		port.setText(""+model.getPort());
	
		add(hostLabel,host);
		add(portLabel, port);
		add(mountpointLabel, mountpoint);
	...
	public void focusLost(FocusEvent e) {
		...
		try{
			...
			}else if(src.equals(mountpoint)){
				model.setMountpoint(mountpoint.getText());
