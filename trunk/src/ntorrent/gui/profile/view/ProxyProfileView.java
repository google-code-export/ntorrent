...
import ntorrent.gui.profile.model.ProxyProfileModel;
...
public class ProxyProfileView extends AbstractView implements ItemListener, FocusListener {
	...
	public ProxyProfileView(ProxyProfileModel model) {
		this.model = model;
		JLabel proxyLabel = new JLabel(Constants.messages.getString("profile.proxy"));
		JLabel hostLabel = new JLabel(Constants.messages.getString("profile.proxy.host"));
		JLabel portLabel = new JLabel(Constants.messages.getString("profile.proxy.port"));
